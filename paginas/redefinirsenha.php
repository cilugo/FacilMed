...
<section class="email-card">
    ...
    <p>Código confirmado com sucesso!</p>
    <p>Digite sua nova senha abaixo.</p>
    <form action="../php/alterarsenha.php" method="POST" id="formNovaSenha">
        <div class="campo">
        ...
        <div class="regras-senha">
            <p>Sua senha deve:</p>
            <ul>
                <li>Ter entre 8 e 9 caracteres</li>
                <li>Ser igual à confirmação</li>
            </ul>
        </div>
...
document.getElementById("formNovaSenha").addEventListener("submit", function(event) {
